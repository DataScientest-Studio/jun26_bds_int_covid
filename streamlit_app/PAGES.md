...
| Modelling | 2:30 | Complexity increased from transparent baselines to CNNs and transfer learning. |
| Results | 3:00 | The current scratch CNN leads on the common held-out split. |
