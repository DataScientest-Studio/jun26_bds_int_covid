...
PRIMARY_MODEL_NAME = "Fine-tuned EfficientNetB0"
PRIMARY_MODEL_PATH = MODELS_DIR / "transfer_efficientnetb0_finetuned.keras"
...
def preload_primary_model():
    """Load the single defense model once and reuse it across predictions."""
    return load_model(str(PRIMARY_MODEL_PATH))
