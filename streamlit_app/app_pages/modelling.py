...
from lib.ui import footer, narrative, page_intro
...
narrative(
    ...
    "Compared dummy and linear baselines, gradient boosting, CNNs trained from scratch, and EfficientNetB0 transfer learning.",
...
cards = [
    ...
    ("03", "CNNs from scratch", "Spatial features learned directly from this dataset."),
